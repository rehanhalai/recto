	...
	return (
		<section className="relative w-full pt-16 pb-8 px-6 sm:px-8 flex flex-col sm:flex-row gap-6 items-end bg-linear-to-b from-indigo-900/30 via-background/95 to-background border-b border-border-subtle/10">
			...
			<div className="relative z-10 shrink-0 group">
				<div className="relative w-48 h-48 sm:w-52 sm:h-52 rounded-lg overflow-hidden shadow-2xl bg-muted/30 border border-white/5 transition-transform duration-300 group-hover:scale-[1.02]">
			...
			<div className="relative z-10 flex-1 w-full pb-1">
				<Badge variant="outline" className="mb-3 uppercase tracking-wider text-[10px] font-bold border-indigo-500/30 text-indigo-400 bg-indigo-500/5">
					Public List
				</Badge>
